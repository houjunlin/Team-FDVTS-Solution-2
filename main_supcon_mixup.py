...
def main():
    ...
    if args.pretrain:
        ...
        # ckpt = torch.load('/home/feng/hjl/eccv-submit/checkpoints/con/*clf_resnest50_con_mix_iccvtest/28.pkl')
        ckpt = torch.load('checkpoints/con/grade_resnest50_con64_mix_catlesion2_nonorm/60.pkl')
        state_dict = ckpt['net']
    ...
    if args.val_certain_epoch:
        ...
        val1(target_model,val_loader,epoch,val_log)
        exit()
